...
//
// Solidity: event L1ChainConfigurationUpdated(uint256 chainID, bytes32 configHash)
func (_Registry *RegistryFilterer) FilterL1ChainConfigurationUpdated(opts *bind.FilterOpts) (*RegistryL1ChainConfigurationUpdatedIterator, error) {

	logs, sub, err := _Registry.contract.FilterLogs(opts, "L1ChainConfigurationUpdated")
	if err != nil {
		return nil, err
	}
...
//
// Solidity: event L1ChainConfigurationUpdated(uint256 chainID, bytes32 configHash)
func (_Registry *RegistryFilterer) WatchL1ChainConfigurationUpdated(opts *bind.WatchOpts, sink chan<- *RegistryL1ChainConfigurationUpdated) (event.Subscription, error) {

	logs, sub, err := _Registry.contract.WatchLogs(opts, "L1ChainConfigurationUpdated")
	if err != nil {
		return nil, err
	}
...
//
// Solidity: event L2ChainConfigurationUpdated(uint256 chainID, bytes32 configHash)
func (_Registry *RegistryFilterer) FilterL2ChainConfigurationUpdated(opts *bind.FilterOpts) (*RegistryL2ChainConfigurationUpdatedIterator, error) {

	logs, sub, err := _Registry.contract.FilterLogs(opts, "L2ChainConfigurationUpdated")
	if err != nil {
		return nil, err
	}
...
//
// Solidity: event L2ChainConfigurationUpdated(uint256 chainID, bytes32 configHash)
func (_Registry *RegistryFilterer) WatchL2ChainConfigurationUpdated(opts *bind.WatchOpts, sink chan<- *RegistryL2ChainConfigurationUpdated) (event.Subscription, error) {

	logs, sub, err := _Registry.contract.WatchLogs(opts, "L2ChainConfigurationUpdated")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
