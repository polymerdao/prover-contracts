...
// UpdateL1ChainConfiguration is a paid mutator transaction binding the contract method 0xcbfc78c2.
//
// Solidity: function updateL1ChainConfiguration((address,address,uint256,uint256) _config, bytes[] _l1StorageProof, bytes _rlpEncodedRegistryAccountData, bytes[] _l1RegistryProof, bytes32 _l1WorldStateRoot) returns()
