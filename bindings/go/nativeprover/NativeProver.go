...
// UpdateL2ChainConfiguration is a paid mutator transaction binding the contract method 0x64eb4cd1.
//
// Solidity: function updateL2ChainConfiguration(uint256 _chainID, (address,address[],uint256[],uint256,uint256) _config, bytes[] _l1StorageProof, bytes _rlpEncodedRegistryAccountData, bytes[] _l1RegistryProof, bytes32 _l1WorldStateRoot) returns()
