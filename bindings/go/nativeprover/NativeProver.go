...
//
// Solidity: function prove((uint256,address,bytes32,bytes32,bytes32) _args, bytes _rlpEncodedL1Header, bytes _rlpEncodedL2Header, bytes _settledStateProof, bytes[] _l2StorageProof, bytes _rlpEncodedContractAccount, bytes[] _l2AccountProof) view returns(uint256 chainID, address storingContract, bytes32 storageSlot, bytes32 storageValue)
...
// ProveL1 is a free data retrieval call binding the contract method 0x21f7f6b4.
//
// Solidity: function proveL1((address,bytes32,bytes32,bytes32) _args, bytes _rlpEncodedL1Header, bytes[] _l1StorageProof, bytes _rlpEncodedContractAccount, bytes[] _l1AccountProof) view returns(uint256 chainID, address storingContract, bytes32 storageSlot, bytes32 storageValue)
func (_NativeProver *NativeProverCaller) ProveL1(opts *bind.CallOpts, _args ProveL1ScalarArgs, _rlpEncodedL1Header []byte, _l1StorageProof [][]byte, _rlpEncodedContractAccount []byte, _l1AccountProof [][]byte) (struct {
	ChainID         *big.Int
	StoringContract common.Address
	StorageSlot     [32]byte
	StorageValue    [32]byte
	...
	var out []interface{}
	err := _NativeProver.contract.Call(opts, &out, "proveL1", _args, _rlpEncodedL1Header, _l1StorageProof, _rlpEncodedContractAccount, _l1AccountProof)
...
//
// Solidity: function proveL1((address,bytes32,bytes32,bytes32) _args, bytes _rlpEncodedL1Header, bytes[] _l1StorageProof, bytes _rlpEncodedContractAccount, bytes[] _l1AccountProof) view returns(uint256 chainID, address storingContract, bytes32 storageSlot, bytes32 storageValue)
func (_NativeProver *NativeProverSession) ProveL1(_args ProveL1ScalarArgs, _rlpEncodedL1Header []byte, _l1StorageProof [][]byte, _rlpEncodedContractAccount []byte, _l1AccountProof [][]byte) (struct {
	ChainID         *big.Int
	StoringContract common.Address
	StorageSlot     [32]byte
	StorageValue    [32]byte
}, error) {
	return _NativeProver.Contract.ProveL1(&_NativeProver.CallOpts, _args, _rlpEncodedL1Header, _l1StorageProof, _rlpEncodedContractAccount, _l1AccountProof)
}

// ProveL1 is a free data retrieval call binding the contract method 0x21f7f6b4.
//
// Solidity: function proveL1((address,bytes32,bytes32,bytes32) _args, bytes _rlpEncodedL1Header, bytes[] _l1StorageProof, bytes _rlpEncodedContractAccount, bytes[] _l1AccountProof) view returns(uint256 chainID, address storingContract, bytes32 storageSlot, bytes32 storageValue)
func (_NativeProver *NativeProverCallerSession) ProveL1(_args ProveL1ScalarArgs, _rlpEncodedL1Header []byte, _l1StorageProof [][]byte, _rlpEncodedContractAccount []byte, _l1AccountProof [][]byte) (struct {
	ChainID         *big.Int
	StoringContract common.Address
	StorageSlot     [32]byte
	StorageValue    [32]byte
