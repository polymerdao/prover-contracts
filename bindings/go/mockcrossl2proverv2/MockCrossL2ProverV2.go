...
func (_MockCrossL2ProverV2 *MockCrossL2ProverV2Caller) ValidateEventSolana(opts *bind.CallOpts, proof []byte) (struct {
	ChainId     uint32
	ProgramID   [32]byte
	LogMessages [][]byte
}, error) {
	var out []interface{}
	err := _MockCrossL2ProverV2.contract.Call(opts, &out, "validateEventSolana", proof)
...
//
// Solidity: function validateEventSolana(bytes proof) view returns(uint32 chainId, bytes32 programID, bytes[] logMessages)
func (_MockCrossL2ProverV2 *MockCrossL2ProverV2Session) ValidateEventSolana(proof []byte) (struct {
	ChainId     uint32
	ProgramID   [32]byte
	LogMessages [][]byte
}, error) {
	return _MockCrossL2ProverV2.Contract.ValidateEventSolana(&_MockCrossL2ProverV2.CallOpts, proof)
}

// ValidateEventSolana is a free data retrieval call binding the contract method 0xed407692.
//
// Solidity: function validateEventSolana(bytes proof) view returns(uint32 chainId, bytes32 programID, bytes[] logMessages)
func (_MockCrossL2ProverV2 *MockCrossL2ProverV2CallerSession) ValidateEventSolana(proof []byte) (struct {
	ChainId     uint32
	ProgramID   [32]byte
	LogMessages [][]byte
}, error) {
