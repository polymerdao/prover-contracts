...
// RINGBUFFERLENGTH is a free data retrieval call binding the contract method 0xb924266f.
//
// Solidity: function RING_BUFFER_LENGTH() view returns(uint256)
func (_CrossL2Prover *CrossL2ProverCaller) RINGBUFFERLENGTH(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _CrossL2Prover.contract.Call(opts, &out, "RING_BUFFER_LENGTH")
...
//
// Solidity: function RING_BUFFER_LENGTH() view returns(uint256)
func (_CrossL2Prover *CrossL2ProverSession) RINGBUFFERLENGTH() (*big.Int, error) {
	return _CrossL2Prover.Contract.RINGBUFFERLENGTH(&_CrossL2Prover.CallOpts)
}

// RINGBUFFERLENGTH is a free data retrieval call binding the contract method 0xb924266f.
//
// Solidity: function RING_BUFFER_LENGTH() view returns(uint256)
func (_CrossL2Prover *CrossL2ProverCallerSession) RINGBUFFERLENGTH() (*big.Int, error) {
	return _CrossL2Prover.Contract.RINGBUFFERLENGTH(&_CrossL2Prover.CallOpts)
}
...
func (_CrossL2Prover *CrossL2ProverCaller) LatestHeight(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _CrossL2Prover.contract.Call(opts, &out, "latestHeight")
...
//
// Solidity: function latestHeight() view returns(uint256)
func (_CrossL2Prover *CrossL2ProverSession) LatestHeight() (*big.Int, error) {
	return _CrossL2Prover.Contract.LatestHeight(&_CrossL2Prover.CallOpts)
}

// LatestHeight is a free data retrieval call binding the contract method 0xe405bbc3.
//
// Solidity: function latestHeight() view returns(uint256)
func (_CrossL2Prover *CrossL2ProverCallerSession) LatestHeight() (*big.Int, error) {
	return _CrossL2Prover.Contract.LatestHeight(&_CrossL2Prover.CallOpts)
}
...
func (_CrossL2Prover *CrossL2ProverSession) ValidateEvent(logIndex *big.Int, proof []byte) (struct {
	...
	return _CrossL2Prover.Contract.ValidateEvent(&_CrossL2Prover.CallOpts, logIndex, proof)
}
...
// VerifyMembership is a free data retrieval call binding the contract method 0x6bba8421.
//
// Solidity: function verifyMembership(bytes32 appHash, bytes key, bytes32 value, (((bytes,bytes)[],bytes,bytes,bytes)[],uint256) proofs) pure returns()
func (_CrossL2Prover *CrossL2ProverCaller) VerifyMembership(opts *bind.CallOpts, appHash [32]byte, key []byte, value [32]byte, proofs Ics23Proof) error {
	var out []interface{}
...
//
// Solidity: function verifyMembership(bytes32 appHash, bytes key, bytes32 value, (((bytes,bytes)[],bytes,bytes,bytes)[],uint256) proofs) pure returns()
func (_CrossL2Prover *CrossL2ProverSession) VerifyMembership(appHash [32]byte, key []byte, value [32]byte, proofs Ics23Proof) error {
...
//
// Solidity: function verifyMembership(bytes32 appHash, bytes key, bytes32 value, (((bytes,bytes)[],bytes,bytes,bytes)[],uint256) proofs) pure returns()
func (_CrossL2Prover *CrossL2ProverCallerSession) VerifyMembership(appHash [32]byte, key []byte, value [32]byte, proofs Ics23Proof) error {
	return _CrossL2Prover.Contract.VerifyMembership(&_CrossL2Prover.CallOpts, appHash, key, value, proofs)
}
